        ...
        <div className="container relative z-10">
          <div className="max-w-3xl fade-up">
            ...
            <h1 className="font-serif text-5xl lg:text-7xl font-bold text-white mb-8 leading-tight">
              Tumbuh Bersama <span className="text-brand-accent italic">Kekayaan Nusantara</span>
            </h1>
            <p className="text-xl text-stone-300 leading-relaxed mb-10">
              Rantai pasok rempah yang andal, transparan, dan berkelanjutan. Kami menghubungkan dedikasi petani lokal dengan standar kebutuhan industri global.
            </p>
            <a href="https://wa.me/6281234567890" className="inline-flex items-center gap-4 px-10 py-5 bg-brand-accent text-brand-primary font-black rounded-xl hover:bg-white transition-all uppercase tracking-widest text-xs">
        ...
        <div className="container">
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="fade-up">
              <h2 className="font-serif text-4xl font-bold text-brand-primary mb-8 leading-tight">Keunggulan Rantai Pasok <br/>Rempah Nusantara</h2>
              <div className="space-y-8">
                <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-stone-500 text-sm leading-relaxed">Kami bekerja sama langsung dengan lebih dari 50 kelompok tani di seluruh Indonesia untuk memangkas rantai distribusi yang tidak efisien.</p>
                  </div>
                </div>
                <div className="flex gap-6">
                  <div className="w-12 h-12 rounded-2xl bg-brand-bg flex items-center justify-center shrink-0 text-2xl">🔬</div>
      ...
      <section className="py-24 bg-brand-primary text-white">
        <div className="container">
          <div className="mb-20">
            ...
            <p className="text-stone-400">Proses yang transparan untuk hasil yang maksimal.</p>
          </div>
          ...
          <div className="bg-white rounded-[40px] p-8 lg:p-20 shadow-xl border border-stone-100 flex flex-col lg:flex-row items-center gap-16">
            <div className="flex-1">
              ...
              <p className="text-stone-500 leading-relaxed mb-10">
                Tim spesialis kami siap membantu Anda menemukan solusi rempah terbaik untuk skala bisnis Anda. Hubungi kami melalui WhatsApp untuk mendapatkan katalog harga grosir terbaru.
              </p>
              <div className="flex flex-wrap gap-4">
                 <a href="https://wa.me/6281234567890" className="flex items-center gap-3 px-8 py-4 bg-[#25D366] text-white font-black rounded-xl hover:brightness-110 transition-all uppercase tracking-widest text-xs">
